...
void kalman_init(double startp, double starta, double sigmap, double sigmaa, unsigned long timestamp) {
...
void kalman_update(double mp, double ma, unsigned long timestamp) {
